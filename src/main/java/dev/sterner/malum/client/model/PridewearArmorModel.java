...
public class PridewearArmorModel extends ArmorModel {
	public static EntityModelLayer LAYER = new EntityModelLayer(Malum.id("pridewear"), "main");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData arm_l = modelPartData.addChild("arm_l", ModelPartBuilder.create().uv(32, 32).cuboid(1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.525F)).uv(48, 32).cuboid(1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.75F)), ModelTransform.pivot(3.0F, 2.0F, 0.0F));
		ModelPartData arm_r = modelPartData.addChild("arm_r", ModelPartBuilder.create().uv(40, 0).cuboid(-5.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.525F)).uv(40, 16).cuboid(-5.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.75F)), ModelTransform.pivot(-3.0F, 2.0F, 0.0F));
