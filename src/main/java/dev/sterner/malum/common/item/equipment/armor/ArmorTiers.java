...
public class ArmorTiers
{
    public enum ArmorTierEnum implements ArmorMaterial {
        SPIRIT_HUNTER("malum:spirit_hunter", 16, new int[]{1, 3, 4, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, MalumItemRegistry.SPIRIT_FABRIC, 0),
        SOUL_STAINED_STEEL("malum:soul_stained_steel", 22, new int[]{2, 6, 7, 3}, 11,  SoundEvents.ITEM_ARMOR_EQUIP_IRON, MalumItemRegistry.SOUL_STAINED_STEEL_INGOT, 2),
        SOUL_STAINED_STRONGHOLD("malum:soul_stained_stronghold", 36, new int[]{4, 7, 9, 5}, 13,  SoundEvents.ITEM_ARMOR_EQUIP_IRON, MalumItemRegistry.SOUL_STAINED_STEEL_INGOT, 5);
