...
public interface MalumObjects {
	...
	Block EMITTER_MIRROR = register("emitter_mirror", new EmitterMirrorBlock<>(HALLOWED_GOLD_PROPERTIES().nonOpaque()).setBlockEntity(MalumBlockEntityRegistry.EMITTER_MIRROR), true);
